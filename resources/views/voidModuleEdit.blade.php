        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">Void Module</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="item_status" class="form-control" id="item_status" value="{{ $pdf->item_status}}">
                          <option></option>
                          <option>Approved</option>
                          <option>Dissapproved</option>
                        </select>
                      ...
                      <div class="row justify-content-end">
                          <div class="col-md-3 offset-md-2">
                            ...
                            <div class="col-md-3 offset-md-1">
                              <a href="{{ route('voidModule') }}" type="button" class="btn btn-block btn-outline-success"> Back</a>
                            </div>
                            <div class="col-auto">
